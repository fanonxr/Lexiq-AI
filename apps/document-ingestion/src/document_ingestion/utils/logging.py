"""Logging configuration for the Document Ingestion service."""
...
def setup_logging() -> logging.Logger:
    ...
    logging.getLogger("aio_pika").setLevel(logging.INFO if settings.debug else logging.WARNING)
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    if name:
        return logging.getLogger(f"document_ingestion.{name}")
    return logging.getLogger("document_ingestion")
