"""Logging configuration for the API Core service."""
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    if name:
        return logging.getLogger(f"api_core.{name}")
    return logging.getLogger("api_core")
...
def log_auth_event(event_type: str, user_id: Optional[str] = None, **kwargs: Any) -> None:
